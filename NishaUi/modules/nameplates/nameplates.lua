...
local function CreateAuraIcon(parent)
	...
	button.count:SetFont(C.media.font, 12 * noscalemult, "OUTLINE")
...
local function UpdateObjects(frame)
	...
	if C["nameplate"].showhealth == true then
		frame.hp:SetSize(C.nameplate.width * noscalemult, (C.nameplate.height + 9) * noscalemult)
	else
...
local function SkinObjects(frame, nameFrame)
	...
	hp.level:SetFont(C.media.font, 12 * noscalemult, "OUTLINE")
	...
	hp.name:SetFont(C.media.font, 12 * noscalemult, "OUTLINE")
	...
	cb.time:SetFont(C.media.font, 12 * noscalemult, "OUTLINE")
	...
	if C.nameplate.showcastbarname == true then
		...
		cb.name:SetFont(C.media.font, 12 * noscalemult, "OUTLINE")
