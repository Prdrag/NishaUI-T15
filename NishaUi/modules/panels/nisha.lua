...
local NishaUIMainFrameIconTopLeft = CreateFrame("Frame", "DownfallTest", NishaUIMainFrame)
...
NishaUIMainFrameIconTopLeft.Background:SetTexture(C["media"].downfall)

local NishaUIMainFrameIconTopRight = CreateFrame("Frame", "DownfallTest", NishaUIMainFrame)
...
NishaUIMainFrameIconTopRight.Background:SetTexture(C["media"].downfall)
...
for i = 1, 8 do
	...
	Downfall[i]:Height((main:GetHeight()/9)-5)
	...
	elseif i == 6 then
		Downfall[i]:SetAttribute("type", "macro")
		Downfall[i]:SetAttribute("macrotext", "/nhelp")
		Downfall[i]:Point("TOPRIGHT", Downfall5, "BOTTOMRIGHT", 0, -3)
		Downfall[i]:SetScript("OnEnter", helpEnter)
		Downfall[i]:SetScript("OnLeave", helpLeave)
		Downfall[i]:HookScript("OnEnter", ModifiedBackdrop)
		Downfall[i]:HookScript("OnLeave", OriginalBackdrop)
		Downfall[i].Text:SetText(T.cStart..L.nisha_help3)		
	elseif i == 7 then
		Downfall[i]:SetAttribute("type", "macro")
	...
	elseif i == 8 then
		...
		Downfall[i]:Point("TOPRIGHT", Downfall7, "BOTTOMRIGHT", 0, -3)
		Downfall[i]:HookScript("OnEnter", ModifiedBackdrop)
		Downfall[i]:HookScript("OnLeave", OriginalBackdrop)
